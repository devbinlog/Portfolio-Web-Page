          ...
          {project.links.find((l) => l.type === 'DEMO') && (
            <div className="mt-4 flex justify-center">
              <a
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded border border-border-default text-sm text-text-primary hover:border-border-strong hover:bg-surface-elevated transition-colors"
              >
